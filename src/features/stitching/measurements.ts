...
// diagram hotspot map. Framework-agnostic on purpose — this file is duplicated
// verbatim in the mobile app (mobile-app/src/features/stitching/measurements.ts),
// mirroring how types/database.ts and the cart/placeOrder modules are shared.
...
/** Parse free text from a numeric input into a number | undefined. */
